...
// - httpOnly: TRUE — auth is fully server-side (there is no browser Supabase client),
//   so the session token is never read by JS. This closes the XSS session-theft risk
//   (audit F-15) far better than a CSP would for this case.
